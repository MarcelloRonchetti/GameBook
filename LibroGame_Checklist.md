...
- [x] Icone app definitive aggiunte (`assets/app-icons/icon.png`, `adaptive-icon.png`, `splash-icon.png` a 1254×1254). `favicon.png` rigenerato a 64×64 via downscaling bicubico PowerShell da `icon.png` per non spedire al browser un PNG da 1.7 MB nella scheda
